<template>
  <div class="graph-panel">
    <div class="panel-header">
      <span class="panel-title">Visualização de Relacionamentos do Grafo</span>
    ...
    <div class="graph-container" ref="graphContainer">
      ...
      <div v-if="graphData" class="graph-view">
        ...
        <div v-if="currentPhase === 1 || isSimulating" class="graph-building-hint">
          ...
          {{ isSimulating ? 'Memória de longo/curto prazo do GraphRAG atualizando em tempo real' : 'Atualizando em tempo real...' }}
        </div>
        ...
        <div v-if="showSimulationFinishedHint" class="graph-building-hint finished-hint">
          ...
          <span class="hint-text">Algum conteúdo ainda está sendo processado. Recomendamos atualizar manualmente o grafo em breve.</span>
          <button class="hint-close-btn" @click="dismissFinishedHint" title="Fechar dica">
          ...
          <div v-else class="detail-content">
            ...
            <template v-if="selectedItem.data.isSelfLoopGroup">
              <div class="edge-relation-header self-loop-header">
                {{ selectedItem.data.source_name }} - Auto-relações
