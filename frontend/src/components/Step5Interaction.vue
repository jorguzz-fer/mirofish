    ...
    <div class="main-split-layout">
      ...
      <div class="left-panel report-style" ref="leftPanel">
        ...
        <div v-if="!reportOutline" class="waiting-placeholder">
          ...
          <span class="waiting-text">Aguardando Agente de Relatório...</span>
        </div>
      </div>
        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-tabs">
            ...
            >
              ...
              <span>Conversar com Agente de Relatório</span>
            </button>
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'Conversar com qualquer indivíduo no mundo' }}</span>
                <svg class="dropdown-arrow" :class="{ open: showAgentDropdown }" viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2">
                  <polyline points="6 9 12 15 18 9"></polyline>
                </svg>
              </button>
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header">Selecionar Alvo da Conversa</div>
                <div 
            ...
            >
              ...
              <span>Enviar Pesquisa ao Mundo</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                <div class="tools-card-name">Agente de Relatório - Chat</div>
                <div class="tools-card-subtitle">Versão de chat rápido do agente de geração de relatórios, com acesso a 4 ferramentas profissionais e memória completa do MiroFish</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Alinha dados sementes do mundo real com o estado do ambiente de simulação, combinando Memória Global/Local para análise de atribuição profunda cross-temporal</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">PanoramaSearch Rastreamento Completo</div>
                    <div class="tool-desc">Algoritmo de travessia em largura baseado em grafos que reconstrói caminhos de propagação de eventos e captura a topologia completa do fluxo de informações</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">QuickSearch Recuperação Rápida</div>
                    <div class="tool-desc">Interface de consulta instantânea baseada em GraphRAG com indexação otimizada para extração rápida de atributos específicos de nós e fatos discretos</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Entrevistas autônomas que conduzem diálogos paralelos de múltiplas rodadas com indivíduos simulados, coletando dados de opinião não estruturados e estados psicológicos</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Converse com o Agente de Relatório para aprofundar o conteúdo do relatório' : 'Converse com indivíduos simulados para conhecer suas perspectivas' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Selecionar Alvos da Pesquisa</span>
            ...
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Perguntas da Pesquisa</span>
              </div>
              <textarea 
                v-model="surveyQuestion"
                class="survey-input"
                placeholder="Digite a pergunta que deseja fazer a todos os alvos selecionados..."
                rows="3"
              ></textarea>
            </div>
...
const selectAgent = (agent, idx) => {
  ...
  addLog(`Alvo de conversa selecionado: ${agent.username}`)
}
...
const sendToReportAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    addLog('Agente de Relatório respondeu')
  } else {
...
const sendToAgent = async (message) => {
  ...
  if (chatHistory.value.length > 1) {
    const historyContext = chatHistory.value
      ...
      .slice(-6)
      .map(msg => `${msg.role === 'user' ? 'Questionador' : 'Você'}: ${msg.content}`)
      .join('\n')
...
const submitSurvey = async () => {
  ...
  addLog(`Enviando pesquisa para ${selectedAgents.value.size} alvos...`)
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      for (const interview of interviews) {
        ...
        surveyResultsList.push({
          agent_id: agentIdx,
          agent_name: agent?.username || `Agente ${agentIdx}`,
    ...
    addLog(`Falha ao enviar pesquisa: ${err.message}`)
  } finally {
...
// Lifecycle
onMounted(() => {
  addLog('Step5 interação profunda inicializando')
  loadReportData()
  loadProfiles()
